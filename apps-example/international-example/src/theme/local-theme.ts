...
//   return classes.filter(Boolean).join(' ') as const;
// };
...
const fill = {
  base: {
    main: classNames('bg-gray-100 dark:bg-gray-800'),
    muted: classNames('bg-gray-200 dark:bg-gray-700'),
    hover: classNames('hover:bg-gray-300 dark:hover:bg-gray-600'),
    disabled: classNames('opacity-50'),
  },
  primary: {
